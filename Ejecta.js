...
// Timers
    window.setTimeout = function (cb, t) {
        return ej.setTimeout(cb, t);
    };
    window.setInterval = function (cb, t) {
        return ej.setInterval(cb, t);
    };
    ...
    window.document = {
        ...
        getElementsByTagName : function (tagName) {
            if (tagName === 'head') {
                ...
                script.parentNode  = new HTMLElement('html');
                return [script];
            }
